                        ...
                        <div className={`lg:h-screen h-full w-full  z-50 lg:flex  grid `} >
                            ...
                            <div className={` flex w-full justify-center z-50 mt-10 flex-1 ${theme.darkTheme ? "text-[#e0d9d9]" : "text-black"}`}>
                                ...
                                <div className="flex flex-col gap-y-4 justify-center w-full px-10 text-center z-50">
                                    ...
                                    <p className="project-text self-center lg:text-3xl text-2xl text-center max-w-[500px]">{project.body}</p>
                                    ...
                                    <div className=" w-full px-10 mx-auto  ">
                                        <div className="max-w-[300px] flex flex-col flex-wrap gap-x-4 mx-auto">

                                            <Link target='blank' href={project.sourceCode} className="flex justify-center w-full" >
                                                <button className="project_btn11 flex items-center justify-center md:h-[60px] h-10 bg-[#cb5858] shadow-2xl mt-3 text-xl  w-full    text-white hover:bg-[#b34c4c] ">
                                                    Code
                                            ...
                                            {project.liveWebsite ?
                                                <Link target='blank' href={project.liveWebsite} className="flex justify-center max-w-full" >
                                                    <button className="flex items-center justify-center md:h-[60px] h-10 bg-[#cb5858] shadow-2xl mt-3 text-xl self-end w-full md:max-w-full  text-white hover:bg-[#b34c4c] ">
                                                        Live Website
