...
//   return (
//     <div className=" flex flex-col lg:flex-row   w-full  h-full contact-wrapper  bg-[#333232] railway relative">
...
//         <div className="md:pt-14 pt-8 grid">
...
//       <ParticlesBackground />
//       <div
//         className={`md:pl-10 pl-6 pr-6 md:pr-0 md:pt-4 h-screen overflow-y-hidden shrink pt-10 pt z-50 ${
//           theme.darkTheme ? "text-white" : "text-black"
//         }`}
//       >
//         <div className="md:text-[40px] text-[30px] motion-text font-bold">
...
function ContactPageee(props) {
  ...
  return (
    ...
    >
      ...
      {/* <div
        className={`w-full md:pl-10 pl-6 pr-6 md:pr-0 md:pt-4 overflow-y-hidden shrink pt-10 pt z-50 ${
          theme.darkTheme ? "text-white" : "text-black"
        }`}
      >
        <div className="md:text-[40px] text-[30px] motion-text font-bold">
        ...
        <div className="mt-2 lg:mt-6 max-w-[620px]">
          <UseAnimatedText text={bodyText} />
        </div>
        <div className="md:pt-8 pt-8 grid">
          <div className="shrink  grid content-evenly">
            <ContactList />
          </div>
          <div className="text-white h-full z-50 pt-6 lg:hidden block">
