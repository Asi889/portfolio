  ...
  return (
    <section className="flex flex-col lg:flex-row h-screen w-full">
      ...
      <a
        ...
        href="https://github.com/Asi889/portfolio"
        className="z-[70] grid place-content-center w-10 h-10 top-auto left-auto right-4 bottom-4 bg-white rounded-full fixed hover:text-primary text-[#24292f]"
      >
        <svg
