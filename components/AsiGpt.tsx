...
export const AsiGpt = memo(function AsiGpt() {
  ...
  return (
    // <section
    //   className={`max-w-lg mx-auto bg-slate-800 p-6 rounded-md w-full h-full relative overflow-hidden transition-opacity duration-1000 ease-in-out transform translate-y-[-100%] opacity-0 animate-slideDown`}
    // >
    <section className="max-w-lg mx-auto bg-slate-800 p-3 md:p-6 rounded-md w-full relative">
