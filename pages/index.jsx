  ...
  return (
    <>
      ...
      <div className="relative h-full ">
        <ParticlesBackground />
        <main className="relative px-4 h-full flex flex-col overflow-auto">
          ...
          <footer className=" railway text-[#d49090] flex justify-center gap-x-6 pt-3 md:gap-x-10 mb-10">
