...
const ProjectPage = () => {
    ...
    return (
        <div id="sec3" className="section3"  >
            <h1 className="things_thatibuilt">Things That I Built</h1>
            <div className="projects-wrapper" >
                {projects ? projects.map((project) => {
                    return (
                        <div className="project">
                            <div className="projec-img-wrapper">

                                <img className="justifyCenter first-img" alt="" src={computerImg}></img>
                                <img className="project-img" alt="" src={project.imgeSource}></img>
                            </div>
                            <h1 className="project-title">{project.title}</h1>
                            <p className="project-text">{project.body}</p>
                            <div className="tech-wrapper">
                                {project.icons.map((icon) => <h3 className="inline project-lang">{icon}</h3>)}
                            </div>
                            <Link href={project.sourceCode} >
                                ...
                                <button className="project_btn11">
                                    code
            ...
            {/* <div className="first_project">
                <h4 className="bold_textF">""GIG-ME"" - Final Bootcamp Project</h4>
                <br></br>
                <img className="" width="200" height="200" alt="" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1639051687/Pngtree_computer_monitor_picture_free_png_5444544_kyucge.png"></img>
                <img className="phone_img" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1616057615/home1_iw3ine.png"></img>
                <img className="phone_img" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1615806723/addg_upmibq.png"></img>
                <img className="phone_img" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1615806723/profilep_qcuadd.png"></img>
                <div className="tt">

                    <p className="first_projecttext">GIG-Me, is a full C2C App, fiverr meets task manager but not for proffesionals. The app is built in React JS framework, and NODE JS server. With MongoDB as the database. check it out, but remember! i am noob!:)  </p>
                    <img className="small_logos" src="https://cubettech.com/wp-content/uploads/2018/09/1280px-React-icon.svg_.png" alt=""></img>
                    <img className="small_logos" src="https://infinapps.com/wp-content/uploads/2018/10/mongodb-logo.png" alt=""></img>
                    <img className="nodejs_logo" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1616057757/1280px-Node.js_logo.svg_i4pajj.png" alt=""></img>

                    <img className="mobx_logo" src="https://raw.githubusercontent.com/ArkejGit/ChessTimer/master/readme_img/mobx-logo.png" alt=""></img>

                </div>
                <a className="btn_link" href="https://github.com/Asi889/gigMeApp">
                    <button className="project_btn1">
                        code
                        <svg className="github_logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 54"><path fill="none" d="M-.2.1h53.8v53.4H-.2z"></path><path d="M15.9 7.7c3.3-1.9 6.9-2.9 10.8-2.9 3.9 0 7.5 1 10.8 2.9s5.9 4.5 7.8 7.8c1.9 3.3 2.9 6.9 2.9 10.8 0 4.7-1.4 8.9-4.1 12.6-2.7 3.7-6.2 6.3-10.6 7.7-.5.1-.9 0-1.1-.2-.2-.2-.4-.5-.4-.8v-5.9c0-1.8-.5-3.1-1.5-4 1.1-.1 2-.3 2.9-.5.8-.2 1.7-.6 2.6-1.1.9-.5 1.7-1.1 2.3-1.9.6-.7 1.1-1.7 1.5-2.9s.6-2.6.6-4.2c0-2.2-.7-4.1-2.2-5.7.7-1.7.6-3.6-.2-5.7-.5-.2-1.3-.1-2.3.3-1 .4-1.8.8-2.6 1.2l-1.1.7c-1.7-.5-3.5-.7-5.4-.7-1.8 0-3.6.2-5.4.7-.3-.2-.7-.5-1.2-.8-.5-.3-1.3-.7-2.3-1.1-1.1-.4-1.9-.5-2.4-.4-.8 2.1-.9 4-.2 5.7-1.4 1.7-2.1 3.6-2.1 5.8 0 1.6.2 3 .6 4.2.4 1.2.9 2.2 1.5 2.9.6.7 1.3 1.4 2.2 1.9.9.5 1.8.9 2.6 1.1.8.2 1.8.4 2.9.5-.7.7-1.2 1.6-1.4 2.9-.4.2-.8.3-1.3.4-.4.1-1 .1-1.6.1s-1.2-.2-1.8-.6c-.6-.4-1.1-1-1.5-1.7-.4-.6-.8-1.1-1.4-1.5-.5-.4-1-.6-1.4-.7l-.6-.1c-.4 0-.7 0-.8.1-.1.1-.2.2-.1.3s.1.3.3.4c.1.1.2.2.4.3l.2.1c.4.2.8.5 1.2 1.1.4.5.7 1 .9 1.4l.3.6c.2.7.7 1.3 1.2 1.7.6.4 1.2.7 1.9.8.7.1 1.3.2 1.9.2.6 0 1.1 0 1.5-.1l.6-.1v4c0 .3-.1.6-.4.8-.2.2-.6.3-1.1.2-4.3-1.4-7.8-4-10.6-7.7S5.1 30.7 5.1 26c0-3.9 1-7.5 2.9-10.8 2-3 4.6-5.6 7.9-7.5zm-2.6 27.9c.1-.1 0-.2-.2-.3-.2-.1-.3 0-.4.1-.1.1 0 .2.2.3.2.1.4.1.4-.1zm.9 1c.1-.1.1-.2-.1-.4s-.3-.2-.4-.1c-.1.1-.1.2.1.4.1.2.3.2.4.1zm.8 1.2c.2-.1.2-.3 0-.5-.1-.2-.3-.3-.5-.2-.2.1-.2.3 0 .5s.4.3.5.2zm1.2 1.2c.1-.1.1-.3-.1-.5s-.4-.3-.6-.1c-.2.1-.1.3.1.5.3.2.5.2.6.1zm1.6.7c.1-.2-.1-.4-.4-.4-.3-.1-.5 0-.5.2-.1.2 0 .3.4.4.2.1.4 0 .5-.2zm1.8.1c0-.2-.2-.3-.5-.3s-.4.1-.4.3c0 .2.2.3.5.3.2 0 .4-.1.4-.3zm1.6-.3c0-.2-.2-.3-.5-.3-.3.1-.4.2-.4.4s.2.3.5.2c.3.1.4-.1.4-.3z"></path></svg>
            ...
            {/* <div className="seconde_project">
                <h4 className="bold_textF">"Weather App/Frisbee App" </h4>
                <img className="phone_img" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1615807003/ww_zv7har.png"></img>
                <div className="tt">
                    <p className="first_projecttext">This is my first full stack project, nothing special right now! but wait until it's upgraded so that frisbee players will know if its a good day to play frisbee at the beach, weather wise of corse. Built in React JS framework, and NODE JS server. With MongoDB as the database  </p>
                    <img className="small_logos" src="https://cubettech.com/wp-content/uploads/2018/09/1280px-React-icon.svg_.png" alt=""></img>
                    <img className="small_logos" src="https://infinapps.com/wp-content/uploads/2018/10/mongodb-logo.png" alt=""></img>
                    <img className="nodejs_logo" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1616057757/1280px-Node.js_logo.svg_i4pajj.png" alt=""></img>
                    <a className="btn_link" href="https://github.com/Asi889/gigMeApp">
            ...
            {/* <div className="seconde_project">
                <h4 className="bold_textF">"Movie Search" </h4>
                <img className="phone_img" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1615806723/moviesearch_1_h2ki6m.png"></img>
                <p className="first_projecttext">Classic Movie Search website. Nothing special, just to have somthing unit i fill this list with some worthable projects, witch i am working on now! so dont worry. So much to do, so little time.  </p>
                <img className="small_logos" src="https://cubettech.com/wp-content/uploads/2018/09/1280px-React-icon.svg_.png" alt=""></img>
                <img className="nodejs_logo" src="https://res.cloudinary.com/dvdzjj8jo/image/upload/v1616057757/1280px-Node.js_logo.svg_i4pajj.png" alt=""></img>
                <a className="btn_link" href="https://github.com/Asi889/gigMeApp">
                    <br></br>
