        ...
        <div id="sec2" className="section2" >
            ...
            <div className="about_text">
                ...
                <p className="second_text">
                    ...
                    <br></br>
                    <em className="bold_text">languages-</em>main-JavaScript(ES5/6) and PHP
                    <br></br>
                    <em className="bold_text"> Frameworks -</em> React,Next.js,Vue, MobX, Redux
                    <br></br>
                    <em className="bold_text"> Client Side -</em> HTML, CSS, Materialiez, BootStarp, Tailwind
                    <br></br>
                    <em className="bold_text"> Server Side & DataBase -</em>
                    Node.js Express, MongoDB, Mongoose,
                    <br></br>
                    <em className="bold_text">Tools -</em>
                    Gitithub,Bitbucket, working in collaboration in Github,Heroku, AWS-EC2
                </p>
                <br></br>
                <br></br>
